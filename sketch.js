...
function setup(){
    ...
    block3=Bodies.rectangle(170,335,20,150,plane_options);
    World.add(world,block3);
    block4=Bodies.rectangle(30,335,20,150,plane_options);
    World.add(world,block4);
    block5=Bodies.rectangle(330,335,20,150,plane_options);
    World.add(world,block5);
    block6=Bodies.rectangle(470,335,20,150,plane_options);
...
function draw(){
  ...
  rect(block3.position.x,block3.position.y,20,150);
  rect(block4.position.x,block4.position.y,20,150);
  rect(block5.position.x,block5.position.y,20,150);
  rect(block6.position.x,block6.position.y,20,150);
  pop();
